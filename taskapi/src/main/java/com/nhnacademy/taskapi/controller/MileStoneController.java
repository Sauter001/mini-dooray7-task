...
public class MileStoneController {
    ...
    public ResponseEntity<DefaultDto> getMilestones(@PathVariable("projectId") Long projectId) {
        List<MilestoneView> milestones = milestoneService.getMilestones(projectId);
        DefaultDto dto = new DefaultDto(200, milestones);
        return ResponseEntity.ok(dto);
    }

    @PostMapping("/{projectId}/milestones")
    public ResponseEntity<DefaultDto> postMilestone(@PathVariable("projectId") Long projectId,
    ...
    public ResponseEntity<DefaultDto> updateMilestone(@PathVariable Long projectId, @PathVariable Long milestoneId,
    ...
    public ResponseEntity<DefaultDto> deleteMilestone(@PathVariable Long projectId, @PathVariable Long milestoneId) {
